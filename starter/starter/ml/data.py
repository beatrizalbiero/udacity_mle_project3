...
def process_data(
    X, categorical_features=cat_features, label=None, training=True,
    ...
    if training is True:
        ...
        pickle.dump(encoder, open('starter/ml/encoder.pkl', 'wb'))
    else:
        encoder = pickle.load(open('starter/ml/encoder.pkl', 'rb'))
